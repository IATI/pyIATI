...
PATH_XSD_NON_IATI = iati.resources.get_test_data_path('valid_non_iati_schema')
...
TYPE_TEST_DATA = {
    ...
    'str': [b'\x80abc', b'\x80abc', '\N{GREEK CAPITAL LETTER DELTA}', '\u0394', '\U00000394'],  # python2.7 warning # pylint: disable=anomalous-unicode-escape-in-string
    'tuple': [(), (1, 2)],
