...
- [Validation] Provide custom error messages for lxml errors stating that a string is not XML caused by published IATI data. [#90]
...
- [Validation] Provide custom error messages for lxml errors stating that a Dataset is not IATI XML caused by published IATI data. [#92]
